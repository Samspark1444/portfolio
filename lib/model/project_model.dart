...
List<Project> projectList = [
  Project(
    'Counter Application',
    'A counter app is a versatile tool designed to help users keep track of counts or tallies for various activities or items. It features a user-friendly interface with simple controls for incrementing or decrementing the count. Ideal for inventory management, event attendance, habit tracking, and more, the app ensures accuracy and efficiency in counting tasks',
    'assets/images/coffee.png',
    'https://github.com/Samspark1444',
  ),
  Project(
